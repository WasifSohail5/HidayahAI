...
export default function GeometricLogo({ size = "md", showText = true, variant = "full" }: GeometricLogoProps) {
  const sizeClasses = {
    sm: {
      container: "w-8 h-8",
      text: "text-sm",
  ...
  if (variant === "icon-only") {
    return (
      <div className="relative">
        <div
          className={`${currentSize.container} bg-gradient-to-br from-emerald-500 via-teal-600 to-emerald-700 rounded-lg flex items-center justify-center shadow-lg relative overflow-hidden`}
        >
          {/* Islamic 8-fold Geometric Pattern */}
          <svg
          ...
          >
            ...
            <path
              d="M24 12L28 16L32 24L28 32L24 36L20 32L16 24L20 16L24 12Z"
              stroke="currentColor"
              strokeWidth="1.5"
              fill="currentColor"
              fillOpacity="0.3"
      ...
      <div className="relative">
        ...
        >
          ...
          >
            ...
            {/* Inner geometric pattern representing guidance */}
            <path
            ...
            <circle cx="34" cy="34" r="1" fill="currentColor" opacity="0.5" />
            <circle cx="14" cy="34" r="1" fill="currentColor" opacity="0.5" />
